...
style={styles.searchButton}>Buscar ); }

const styles = { searchBar: { display: 'flex', alignItems: 'center', margin: '10px 0', }, searchInput: { padding: '10px', width: '300px', marginRight: '10px', }, searchButton: { padding: '10px 20px', backgroundColor: '#2c3e50', color: 'white', border: 'none', cursor: 'pointer', }, };
