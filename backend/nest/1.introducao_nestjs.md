...
Este material foi revisado para **NestJS 10**. Para seguir os tutoriais em casa, use:

- **Node.js** 18 ou superior (recomendado: LTS 20+).
- **TypeScript** 4.8 ou superior.
- **npm** ou **yarn** para gerenciar dependências.

O NestJS 10 exige Node.js 16+ e compila para ES2021; com Node 18+ os exemplos deste material devem funcionar sem alterações.
...
- [NestJS Migration Guide](https://docs.nestjs.com/migration-guide) (atualizações entre versões)
