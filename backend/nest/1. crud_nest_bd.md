...
Até esse ponto você já criou o módulo de `users`, um `controller` e um `service` para esse módulo. Hora de ver funcionando o que fizemos até agora. No terminal execute o seguinte comando:
